...
const items = [
  <div className="animate-[slideUp_0.5s_ease-in-out]">
    <button
      data-aos="zoom-y-out"
      data-aos-delay={150}
      className="transtion group flex h-[30px] w-fit mx-auto text-[13px] font-switzer font-[400] leading-[19.5px] items-center justify-center rounded-full bg-gradient-to-r from-transparent via-slate-300 to-transparent p-[1px] text-[#758599] duration-300 hover:bg-gradient-to-l cursor-default"
    >
